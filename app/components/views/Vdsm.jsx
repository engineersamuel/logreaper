...
class Vdsm extends Component {
    ...
    render() {
        ...
        let timeSeriesSeverityCounts = DataUtils.makeTimeSeriesData(this.props.file.identification.parseSeverities, this.state.groups.timestampGroups);
        ...
        // Only really want to display ERROR and WARN as that is the only interesting thing for break/fix analysis
        // Yes surrounding lines can be useful, but in this context, it isn't feasible to parse them out
        let fields = ['command', 'threadId', 'component', 'module'];
